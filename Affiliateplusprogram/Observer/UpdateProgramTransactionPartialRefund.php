...
class UpdateProgramTransactionPartialRefund extends AbtractObserver implements ObserverInterface
{
    /**
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $collection = $this->_programTransactionCollectionFactory->create()
